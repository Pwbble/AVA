...
#include "StrongholdTriangulator.h"
#include "Location.h"
...
STri::StrongholdTriangulator::StrongholdTriangulator(const std::string_view &name) : SubProgram(name) {}

Location STri::StrongholdTriangulator::triangulate(Location& pos1, Location& pos2) {
...
Location STri::StrongholdTriangulator::getLocation(int id) {
    float x, z, yaw;
    // Get location
    cout << "Enter x" << id << ": ";
    cin >> x;
...
int STri::StrongholdTriangulator::run() {
